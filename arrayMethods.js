...
const born16century = inventors.filter((inventor) => {
  return inventor.year > 1500 && inventor.year < 1600;
});

const born16century2 = inventors.filter((inventor) => {
...
console.log(birthYear); //waarom krijg ik deze in een array van 3 langs elkaar?
